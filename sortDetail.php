...
$id=$_REQUEST['id'];
$proInfo=getProInfo($id);
$proImgs=getAllImg($proInfo['id']);
?>
<!doctype html>
<html>
<head>
...
<div class="headerBar">
	...
	<div class="logoBar">
		<div class="comWidth">
			<div class="logo fl">
				<a href="index.php"><img src="images/logo.png" alt="潮人网"></a>
			</div>
...
<div class="userPosition comWidth">
	...
	<span>&nbsp;&gt;&nbsp;</span>
	<a href="#"><?php echo $proInfo['commodityName'];?></a>
	<span>&nbsp;&gt;&nbsp;</span>
	<em><?php echo $proInfo['sort_name'];?></em>
</div>
	...
	<div class="description clearfix">
		<div class="leftArea">
			<div class="description_imgs">
				<div class="big">
				<!-- 默认选择第一张商品图片 -->
					<a href=img_800/<?php echo $proImgs[0]['img_src'];  ?> class="jqzoom" rel='gal1'  title="triumph" >
           			 <img width="309" height="340" src=<?php echo 'img_350/'.$proImgs[0]['img_src']; ?>   title="triumph">
	        		</a>
				</div>
				<ul class="des_smimg clearfix" id="thumblist" >
 				<?php foreach($proImgs as $proImg):?>
					<li style="margin: 10px 5px;"><a class=" active" href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: 'img_350/<?php echo $proImg['img_src'];?>',largeimage: 'img_800/<?php echo $proImg['img_src'];?>'}"><img src="img_50/<?php echo $proImg['img_src'];?>" alt=""></a></li>
				<?php endforeach;?>
				</ul>
			</div>
		</div>
		<div class="rightArea">
			<div class="des_content">
				<h3 class="des_content_tit"></h3>
				<div class="dl clearfix">
					<div class="dt">潮人价</div>
					<div class="dd clearfix"><span class="des_money"><?php echo $proInfo['sort_price'];?> <em>￥</em></span></div>
				</div>
				<div class="dl clearfix">
					<div class="dt">优惠</div>
					...
					<div class="dl">
						...
						<div class="dd clearfix">
							<div class="des_number">
								...
								<div class="des_input">
									<input type="text" value=<?php echo $proInfo['sort_num'];?>>
								</div>
								<div class="plus">+</div>
							</div>
...
<div class="hr_25"></div>
<div class="footer">
	<p><a href="#">潮人简介</a><i>|</i><a href="#">潮人公告</a><i>|</i> <a href="#">招纳贤士</a><i>|</i><a href="#">联系我们</a><i>|</i>客服热线：400-675-1234</p>
